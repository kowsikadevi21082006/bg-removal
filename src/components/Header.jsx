...
const Header = () => {
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4mt-10 lg:px-44 sm:mt-20'>
        {/* ------Left Side------*/}
        <div>
            ...
            <p className='my-6 text-[15px] text-gray-500 '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ut dolore <br className='max-sm:hidden'/> nesciunt sit illum error repellat repudiandae reiciendis animi!</p>
            <div>
                ...
                <label className='inline-flex gap-3 px-8 py-3.5 rounded-full cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-500 m-auto hover:scale-105 transition-all duration-700' htmlFor="upload1">
                    ...
                    <p className='text-white text-5m '>Upload your image</p>
                </label>
            </div>
        </div>
        {/*-------Right Side-------*/}
